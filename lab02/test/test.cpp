...
TEST(ProgramingLab00, test_get_animal_by_name)
{
  ...
  AnimalType input_data[] = { CAT, DOG, COW, PIG, HUMAN, ANIMAL_TYPE_COUNT, static_cast<AnimalType>(ANIMAL_TYPE_COUNT + 1) };
  string expected_values[] = { "Кіт", "Собака", "Корова", "Свиня", "Людина", "N/A", "N/A" };
